 ...
 */
@Repository
interface StorageConfigRepository : JpaRepository<StorageConfig?, Int?> {
    /**
     * 根据存储类型找对应的配置信息
     *
     * @param   type
     ...
     * @return  此类型所有的配置信息
     */
    fun findByTypeOrderById(type: StorageTypeEnum?): List<StorageConfig?>?
     ...
     * @return  此驱动器所有的配置信息
     */
    fun findByDriveIdOrderById(driveId: String): List<StorageConfig>
     ...
     * @return  此驱动器所有的配置信息
     */
    fun findByDriveId(driveId: String?): List<StorageConfig?>?
