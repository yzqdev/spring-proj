...
class HuaweiServiceImpl : AbstractS3BaseFileService(), BaseFileService {
    override fun init(driveId: String?) {
        ...
        if (Objects.isNull(accessKey) || Objects.isNull(secretKey) || Objects.isNull(endPoint) || Objects.isNull(
            ...
            s3Client = AmazonS3ClientBuilder.standard()
                ...
                .withEndpointConfiguration(AwsClientBuilder.EndpointConfiguration(endPoint, "obs")).build()
            testConnection()
            isInitialized = true
        }
    }
    ...
    companion object {
        private val log = LoggerFactory.getLogger(HuaweiServiceImpl::class.java)
    }
}