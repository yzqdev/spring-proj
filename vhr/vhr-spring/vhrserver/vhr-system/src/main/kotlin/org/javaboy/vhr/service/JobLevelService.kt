...
class JobLevelService {
    @Autowired
    var jobLevelMapper: JobLevelMapper? = null
    val allJobLevels: List<JobLevel?>?
        get() = jobLevelMapper.getAllJobLevels()

    fun addJobLevel(jobLevel: JobLevel): Int {
        jobLevel.createDate = Date()
        jobLevel.enabled = true
        return jobLevelMapper!!.insertSelective(jobLevel)
    }

    fun updateJobLevelById(jobLevel: JobLevel?): Int {
        return jobLevelMapper!!.updateByPrimaryKeySelective(jobLevel)
    }

    fun deleteJobLevelById(id: Int?): Int {
        return jobLevelMapper!!.deleteByPrimaryKey(id)
    }

    fun deleteJobLevelsByIds(ids: Array<Int?>?): Int? {
