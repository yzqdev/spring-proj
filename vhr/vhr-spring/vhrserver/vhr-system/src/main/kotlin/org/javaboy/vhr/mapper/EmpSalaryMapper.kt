...
interface EmpSalaryMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: EmpSalary?): Int
    fun insertSelective(record: EmpSalary?): Int
    fun selectByPrimaryKey(id: Int?): EmpSalary?
    fun updateByPrimaryKeySelective(record: EmpSalary?): Int
    fun updateByPrimaryKey(record: EmpSalary?): Int
}