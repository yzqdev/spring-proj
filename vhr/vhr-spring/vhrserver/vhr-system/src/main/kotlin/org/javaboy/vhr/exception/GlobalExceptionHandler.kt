package org.javaboy.vhr.exceptionimport
...
class GlobalExceptionHandler {
    ...
    fun sqlException(e: SQLException?): RespBean {
        return if (e is SQLIntegrityConstraintViolationException) {
            RespBean.error("该数据有关联数据，操作失败!")
        } else RespBean.error("数据库异常，操作失败!")
    }
}