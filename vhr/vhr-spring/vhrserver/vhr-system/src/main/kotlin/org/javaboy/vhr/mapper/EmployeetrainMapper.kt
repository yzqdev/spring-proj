...
interface EmployeetrainMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: Employeetrain?): Int
    fun insertSelective(record: Employeetrain?): Int
    fun selectByPrimaryKey(id: Int?): Employeetrain?
    fun updateByPrimaryKeySelective(record: Employeetrain?): Int
    fun updateByPrimaryKey(record: Employeetrain?): Int
}