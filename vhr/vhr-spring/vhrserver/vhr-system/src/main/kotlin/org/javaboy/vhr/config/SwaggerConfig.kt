package org.javaboy.vhr.configimportimportimport

io.swagger.v3.oas.annotations.OpenAPIDefinitionimport io.swagger.v3.oas.annotations.enums.SecuritySchemeInimport io.swagger.v3.oas.annotations.enums.SecuritySchemeTypeimport org.javaboy.vhr.model.Employee.nameimport org.javaboy.vhr.model.Hr.nameimport org.javaboy.vhr.model.JobLevel.nameimport org.springdoc.core.GroupedOpenApiimport org.springframework.context.annotation .Configuration io.swagger.v3.oas.annotations.info.Contactimport io.swagger.v3.oas.annotations.info.Infoimport io.swagger.v3.oas.annotations.security.SecurityRequirementimport io.swagger.v3.oas.annotations.security.SecuritySchemeimport org.springframework.context.annotation .Bean
...
class SwaggerConfig {
    ...
    fun docker(): GroupedOpenApi {
        return GroupedOpenApi.builder()
            .packagesToScan("org.javaboy.vhr.controller")
            .group("api")
            .pathsToMatch("/**").build()
    }
}