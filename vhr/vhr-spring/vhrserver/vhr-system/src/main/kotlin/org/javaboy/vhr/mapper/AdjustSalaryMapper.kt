...
interface AdjustSalaryMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: AdjustSalary?): Int
    fun insertSelective(record: AdjustSalary?): Int
    fun selectByPrimaryKey(id: Int?): AdjustSalary?
    fun updateByPrimaryKeySelective(record: AdjustSalary?): Int
    fun updateByPrimaryKey(record: AdjustSalary?): Int
}