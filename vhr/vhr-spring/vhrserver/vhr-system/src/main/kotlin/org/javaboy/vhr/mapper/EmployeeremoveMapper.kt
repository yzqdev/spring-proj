...
interface EmployeeremoveMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: Employeeremove?): Int
    fun insertSelective(record: Employeeremove?): Int
    fun selectByPrimaryKey(id: Int?): Employeeremove?
    fun updateByPrimaryKeySelective(record: Employeeremove?): Int
    fun updateByPrimaryKey(record: Employeeremove?): Int
}