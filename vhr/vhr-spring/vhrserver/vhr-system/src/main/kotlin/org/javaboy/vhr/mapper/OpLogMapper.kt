...
interface OpLogMapper {
    ...
    fun insert(record: OpLog?): Int
    fun insertSelective(record: OpLog?): Int
    fun selectByPrimaryKey(id: Int?): OpLog?
    fun updateByPrimaryKeySelective(record: OpLog?): Int
    fun updateByPrimaryKey(record: OpLog?): Int
}