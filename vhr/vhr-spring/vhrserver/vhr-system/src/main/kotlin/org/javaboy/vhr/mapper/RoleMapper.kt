...
interface RoleMapper {
    ...
    fun insertSelective(record: Role?): Int
    fun selectByPrimaryKey(id: Int?): Role?
    fun updateByPrimaryKeySelective(record: Role?): Int
    fun updateByPrimaryKey(record: Role?): Int
