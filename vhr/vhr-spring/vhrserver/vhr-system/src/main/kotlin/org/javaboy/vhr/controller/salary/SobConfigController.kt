...
class SobConfigController {
    ...
    @GetMapping("/")
    fun getEmployeeByPageWithSalary(
    ...
    @get:GetMapping("/salaries")
    val allSalaries: List<Salary?>?
        get() = salaryService.getAllSalaries()

    @PutMapping("/")
    fun updateEmployeeSalaryById(eid: Int?, sid: Int?): RespBean {
        val result = employeeService!!.updateEmployeeSalaryById(eid, sid)
