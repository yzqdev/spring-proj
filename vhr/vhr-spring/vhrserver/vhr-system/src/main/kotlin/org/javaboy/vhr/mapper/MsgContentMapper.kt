...
interface MsgContentMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: MsgContent?): Int
    fun insertSelective(record: MsgContent?): Int
    fun selectByPrimaryKey(id: Int?): MsgContent?
    fun updateByPrimaryKeySelective(record: MsgContent?): Int
    fun updateByPrimaryKey(record: MsgContent?): Int
}