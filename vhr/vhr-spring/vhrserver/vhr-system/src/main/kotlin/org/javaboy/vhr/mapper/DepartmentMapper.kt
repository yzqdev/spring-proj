...
interface DepartmentMapper {
    ...
    fun insert(record: Department?): Int
    fun insertSelective(record: Department?): Int
    fun selectByPrimaryKey(id: Int?): Department?
    fun updateByPrimaryKeySelective(record: Department?): Int
    fun updateByPrimaryKey(record: Department?): Int
    fun getAllDepartmentsByParentId(pid: Int?): List<Department?>?
