...
interface PoliticsstatusMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: Politicsstatus?): Int
    fun insertSelective(record: Politicsstatus?): Int
    fun selectByPrimaryKey(id: Int?): Politicsstatus?
    fun updateByPrimaryKeySelective(record: Politicsstatus?): Int
    fun updateByPrimaryKey(record: Politicsstatus?): Int
