...
class MailSendLogService {
    @Autowired
    var mailSendLogMapper: MailSendLogMapper? = null
    fun updateMailSendLogStatus(msgId: String?, status: Int?): Int? {
    ...
    val mailSendLogsByStatus: List<MailSendLog?>?
        get() = mailSendLogMapper.getMailSendLogsByStatus()

    fun updateCount(msgId: String?, date: Date?): Int? {
