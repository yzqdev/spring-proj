...
interface NationMapper {
    ...
    fun insert(record: Nation?): Int
    fun insertSelective(record: Nation?): Int
    fun selectByPrimaryKey(id: Int?): Nation?
    fun updateByPrimaryKeySelective(record: Nation?): Int
    fun updateByPrimaryKey(record: Nation?): Int
