...
interface EmployeeecMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: Employeeec?): Int
    fun insertSelective(record: Employeeec?): Int
    fun selectByPrimaryKey(id: Int?): Employeeec?
    fun updateByPrimaryKeySelective(record: Employeeec?): Int
    fun updateByPrimaryKey(record: Employeeec?): Int
}