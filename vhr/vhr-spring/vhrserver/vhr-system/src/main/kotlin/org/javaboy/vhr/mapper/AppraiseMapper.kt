...
interface AppraiseMapper {
    fun deleteByPrimaryKey(id: Int?): Int
    fun insert(record: Appraise?): Int
    fun insertSelective(record: Appraise?): Int
    fun selectByPrimaryKey(id: Int?): Appraise?
    fun updateByPrimaryKeySelective(record: Appraise?): Int
    fun updateByPrimaryKey(record: Appraise?): Int
}