<template>
  <div v-if="hasPerm('sysMachine:query')">
    ...
    <el-row :gutter="24">
      <el-col :md="12" :sm="24">
        <el-card :loading="loading" title="系统信息" style="margin-bottom: 20px" :bordered="false">
      ...
      <el-col :md="12" :sm="24">
        <el-card :loading="loading" title="Java信息" style="margin-bottom: 20px">
          <table class="sysInfo_table" >
    ...
    <el-card :loading="loading" title="JVM内存信息" >
      <table class="sysInfo_table" >
