<template>
  ...
  <el-row :gutter="24" >
    <el-col :md="5" :sm="24">
      <el-card :bordered="false" :loading="treeLoading">
    ...
    <el-col :md="19" :sm="24">
      <el-card :bordered="false">
            ...
            <el-row :gutter="48">
              <el-col :md="8" :sm="24">
                <el-form-item label="关键词" >
                  <el-input v-model="queryParam.searchValue" allow-clear placeholder="请输入姓名、账号、手机号"/>
                </el-form-item>
              </el-col>
              <el-col :md="8" :sm="24">
                <el-form-item label="状态">
                  <el-select v-model="queryParam.searchStatus" allow-clear placeholder="请选择状态" default-value="0">
        ...
        <div class="table-operator" v-if="hasPerm('sysUser:add')" >
          <el-button type="primary" v-if="hasPerm('sysUser:add')" icon="plus" @click="$refs.addForm.add()">新增用户</el-button>
        </div>
        ...
        >
          ...
          <span slot="action" slot-scope="text, record">
            ...
            <el-divider type="vertical" v-if="hasPerm('sysUser:edit')" />
            <a-dropdown v-if="hasPerm('sysUser:resetPwd') || hasPerm('sysUser:grantRole') || hasPerm('sysUser:grantData') || hasPerm('sysUser:delete')">
              ...
              <el-menu slot="overlay">
                <el-menu-item v-if="hasPerm('sysUser:resetPwd')">
                  <a-popconfirm placement="topRight" title="确认重置密码？" @confirm="() => resetPwd(record)">
                    <a>重置密码</a>
                  </a-popconfirm>
                </el-menu-item>
                <el-menu-item v-if="hasPerm('sysUser:grantRole')">
                  <a @click="$refs.userRoleForm.userRole(record)">授权角色</a>
                </el-menu-item>
                <el-menu-item v-if="hasPerm('sysUser:grantData')">
                  <a @click="$refs.userOrgForm.userOrg(record)">授权数据</a>
                </el-menu-item>
                <el-menu-item v-if="hasPerm('sysUser:delete')">
