    ...
    <a-spin :spinning="formLoading">
      <el-form :form="form">
        ...
        <el-form-item
          ...
          has-feedback
        >
          <el-input placeholder="请输入唯一编码" :disabled="editDisabled" v-decorator="['code', {rules: [{required: true, message: '请输入唯一编码！'}]}]" />
        </el-form-item>
        ...
        <el-form-item
          ...
          :wrapperCol="wrapperCol"
        >
          <el-radio-group :disabled="editDisabled" v-decorator="['sysFlag',{rules: [{ required: true, message: '请选择是否为系统参数！' }]}]" >
        ...
        <el-form-item
          ...
          has-feedback
        >
          <el-select :disabled="editDisabled" style="width: 100%" placeholder="请选择所属分类" v-decorator="['groupCode', {rules: [{ required: true, message: '请选择取所属分类！' }]}]" >
