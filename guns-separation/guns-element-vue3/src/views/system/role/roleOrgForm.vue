    ...
    <a-spin :spinning="formLoading">
      <el-form :form="form">
        <el-form-item
          ...
          has-feedback
        >
          <el-select style="width: 100%" placeholder="请选择授权范围" v-decorator="['dataScopeType', {rules: [{ required: true, message: '请选择授权范围！' }]}]" >
            <el-option v-for="(item,index) in dataScopeTypeData" :key="index" :value="item.code" @click="handleChange(item.code)">{{ item.value }}</el-option>
          </el-select>
        </el-form-item>
