    ...
    <el-col :md="19" :sm="24">
      <el-card :bordered="false">
            ...
            <el-row :gutter="48">
              <el-col :md="8" :sm="24">
                <el-form-item label="机构名称" >
                  <el-input v-model="queryParam.name" allow-clear placeholder="请输入机构名称"/>
                </el-form-item>
              </el-col>
              <el-col :md="8" :sm="24">
        ...
        <div class="table-operator" v-if="hasPerm('sysOrg:add')" >
          <el-button type="primary" v-if="hasPerm('sysOrg:add')" icon="plus" @click="$refs.addForm.add()">新增机构</el-button>
        </div>
        ...
        >
          <span slot="action" slot-scope="text, record">
            ...
            <el-divider type="vertical" v-if="hasPerm('sysOrg:edit') & hasPerm('sysOrg:delete')"/>
