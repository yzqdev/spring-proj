...
<template>
  ...
  <el-card :bordered="false">
    ...
    <div class="table-operator" v-if="hasPerm('sysMenu:add')" >
      <el-button type="primary" v-if="hasPerm('sysMenu:add')" icon="plus" @click="$refs.addForm.add()">新增菜单</el-button>
    </div>
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        <template>
          ...
          <el-divider type="vertical" v-if="hasPerm('sysMenu:edit') & hasPerm('sysMenu:delete')"/>
