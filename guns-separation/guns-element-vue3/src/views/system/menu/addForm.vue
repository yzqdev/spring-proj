      ...
      <el-form :form="form" >
        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              hasFeedback
            >
              <el-input placeholder="请输入菜单名称" v-decorator="['name',{rules: [{required: true, min: 1, message: '请输入菜单名称！'}]}]" />
            </el-form-item>
          </el-col>
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              hasFeedback
            >
              <el-input placeholder="请输入菜单编号" v-decorator="['code', {rules: [{required: true, min: 1, message: '请输入菜单编号！'}]}]" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              has-feedback
            >
              <el-select style="width: 100%" placeholder="请选择应用分类" v-decorator="['application', {rules: [{ required: true, message: '请选择应用分类！' }]}]" >
                <el-option v-for="(item,index) in appData" :key="index" :value="item.code" @click="changeApplication(item.code)">{{ item.name }}</el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              label="菜单层级"
            >
              <el-radio-group v-decorator="['type',{rules: [{ required: true, message: '请选择菜单层级！' }]}]" >
                <el-radio v-for="(item,index) in typeData" :key="index" :value="item.code" @click="meneTypeFunc(item.code)">{{ item.value }}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            ...
            <div v-show="redirectShow">
              ...
              >
                <span slot="label">
                  <el-tooltip title="如需打开首页加载此目录下菜单，请填写加载菜单路由，设为首页后其他设置的主页将被替代">
                    <a-icon type="question-circle-o" />
                  </el-tooltip>&nbsp;
                  重定向
                </span>
                <el-input prop="redirect" placeholder="请输入重定向地址" v-decorator="['redirect']" />
              </el-form-item>
            </div>
          </el-col>
          <el-col :md="12" :sm="24">
            ...
            >
              <span slot="label">
                <el-tooltip title="按钮：无，菜单：内链、外链、组件">
                  <a-icon type="question-circle-o" />
                </el-tooltip>&nbsp;
                打开方式
              </span>
              <el-radio-group :disabled="openTypeDisabled" v-decorator="['openType',{rules: [{ required: true, message: '请选择打开方式！' }]}]">
                <el-radio v-for="(item,index) in openTypeData" :key="index" :value="item.code" @click="meneOpenTypeFunc(item.code)">{{ item.value }}</el-radio>
              </el-radio-group>
            </el-form-item>
        ...
        <el-row :gutter="24" >
          <el-col :md="12" :sm="24">
            <div v-show="componentShow">
              ...
              >
                <span slot="label">
                  <el-tooltip title="前端vue组件 views文件夹下路径，例：system/menu/index。注：目录级填写：RouteView(不带面包屑)，PageView(带面包屑)，菜单级内链打开http链接填写：Iframe">
                    <a-icon type="question-circle-o" />
                  </el-tooltip>&nbsp;
                  前端组件
                </span>
                <el-input placeholder="请输入前端组件" :disabled="componentDisabled" prop="component" v-decorator="['component',{rules: [{required: componentRequired, message: '请输入前端组件'}]}]"/><!-- ,{rules: [{required: componentRequired, min: 1, message: '请输入前端组件！'}]}  -->
              </el-form-item>
            </div>
          </el-col>
          <el-col :md="12" :sm="24">
            <div v-show="routerShow">
              ...
              >
                <span slot="label">
                  <el-tooltip title="浏览器显示的URL，例：/menu，对应打开页面为菜单页面">
                    <a-icon type="question-circle-o" />
                  </el-tooltip>&nbsp;
                  路由地址
                </span>
                <el-input placeholder="请输入路由" v-decorator="['router', {rules: [{required: routerRequired, message: '请输入路由！'}]}]" />
              </el-form-item>
            </div>
            <div v-show="permissionShow">
              <el-form-item
                ...
                hasFeedback
              >
                <el-input placeholder="请输入权限标识" v-decorator="['permission', {rules: [{required: permissionRequired, message: '请输入权限标识！'}]}]" />
              </el-form-item>
            </div>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            <div v-show="linkShow" >
              ...
              >
                <span slot="label">
                  <el-tooltip title="当选择了需要内链或外链打开的选项，此处输入要打开的链接地址，例：https://www.stylefeng.cn">
                    <a-icon type="question-circle-o" />
                  </el-tooltip>&nbsp;
                  内外链地址
                </span>
                <el-input placeholder="请输入内链打开地址" :disabled="linkDisabled" v-decorator="['link', {rules: [{required: linkRequired, message: '请输入权限标识！'}]}]" />
              </el-form-item>
            </div>
          </el-col>
          <el-col :md="12" :sm="24">
            <div v-show="iconShow" >
              <el-form-item
                ...
                label="图标"
              >
                <el-input placeholder="请选择图标" disabled="disabled" v-decorator="['icon']" >
        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            ...
            >
              <span slot="label">
                <el-tooltip title="系统权重：菜单可分配给任何角色，业务权重：菜单对超级管理员不可见">
                  <a-icon type="question-circle-o" />
                </el-tooltip>&nbsp;
                权重
              </span>
              <el-radio-group v-decorator="['weight']">
                <el-radio v-for="(item,index) in weightData" :key="index" :value="item.code" >{{ item.value }}</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :md="12" :sm="24">
        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              label="排序"
            >
              <el-input-number style="width: 100%" v-decorator="['sort', { initialValue: 100 }]" :min="1" :max="1000" />
            </el-form-item>
          </el-col>
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              hasFeedback
            >
              <el-input placeholder="请输入备注" v-decorator="['remark']"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
