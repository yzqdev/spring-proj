        ...
        <el-row :gutter="24">
          <el-col :md="12" :sm="24">
            <el-form-item
              ...
              has-feedback
            >
              <el-select style="width: 100%" :disabled="appDisabled" placeholder="请选择应用分类" v-decorator="['application', {rules: [{ required: true, message: '请选择应用分类！' }]}]" >
          ...
          <el-col :md="12" :sm="24">
            <div v-show="componentShow">
              ...
              >
                ...
                <el-input placeholder="请输入前端组件" :disabled="componentDisabled" prop="component" v-decorator="['component',{rules: [{required: componentRequired, message: '请输入前端组件'}]}]"/>
              </el-form-item>
            </div>
          </el-col>
          <el-col :md="12" :sm="24">
