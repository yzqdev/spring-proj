<template>
  <el-card :bordered="false">
        ...
        <el-row :gutter="48">
          <el-col :md="8" :sm="24">
            <el-form-item label="任务名称">
              <el-input v-model="queryParam.timerName" allow-clear placeholder="请输入任务名称"/>
            </el-form-item>
          </el-col>
          <el-col :md="8" :sm="24">
            <el-form-item label="任务状态">
              <el-select v-model="queryParam.jobStatus" placeholder="请选择状态" >
                <el-option v-for="(item,index) in jobStatusDictTypeDropDown" :key="index" :value="item.code" >{{ item.value }}</el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :md="8" :sm="24">
    ...
    <div class="table-operator" v-if="hasPerm('sysTimers:add')" >
      <el-button type="primary" v-if="hasPerm('sysTimers:add')" icon="plus" @click="$refs.addForm.add()">新增定时器</el-button>
    </div>
    <s-table
      ref="table"
      size="default"
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        ...
        <el-divider type="vertical" v-if="hasPerm('sysTimers:edit') & hasPerm('sysTimers:delete')"/>
