  ...
  >
    <el-card :bordered="false">
          ...
          <el-row :gutter="48">
            <el-col :md="8" :sm="24">
              <el-form-item label="字典值" >
                <el-input v-model="queryParam.value" allow-clear placeholder="请输入字典值"/>
              </el-form-item>
            </el-col>
            <el-col :md="8" :sm="24">
      ...
      <div class="table-operator" v-if="hasPerm('sysDictData:add')" >
        <el-button type="primary" v-if="hasPerm('sysDictData:add')" icon="plus" @click="$refs.addForm.add(typeId)">新增数据</el-button>
      </div>
      <s-table
        ref="table"
        size="default"
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <el-divider type="vertical" v-if="hasPerm('sysDictData:edit') & hasPerm('sysDictData:delete')"/>
