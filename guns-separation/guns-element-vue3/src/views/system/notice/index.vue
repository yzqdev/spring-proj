<template>
  <el-card :bordered="false">
    ...
    <div class="table-operator" v-if="hasPerm('sysNotice:add')" >
      <el-button v-if="hasPerm('sysNotice:add')" type="primary" @click="$refs.addForm.add()" icon="plus" >新增公告</el-button>
    </div>
    <s-table
      ref="table"
      size="default"
    ...
    >
      ...
      <span slot="action" slot-scope="text, record">
        <div v-if="record.status == 0">
          ...
          <el-divider type="vertical" v-if="hasPerm('sysNotice:detail') & hasPerm('sysNotice:edit')"/>
          <a v-if="hasPerm('sysNotice:edit')" @click="$refs.editForm.edit(record)">编辑</a>
          <el-divider type="vertical" v-if="hasPerm('sysNotice:edit') & hasPerm('sysNotice:changeStatus')"/>
        ...
        <div v-if="record.status == 1">
          <a v-if="hasPerm('sysNotice:detail')" @click="$refs.detailForm.detail(record)">查看</a>
          <el-divider type="vertical" v-if="hasPerm('sysNotice:detail') & hasPerm('sysNotice:changeStatus')"/>
        ...
        <div v-if="record.status == 2">
          <a v-if="hasPerm('sysNotice:detail')" @click="$refs.detailForm.detail(record)">查看</a>
          <el-divider type="vertical" v-if="hasPerm('sysNotice:detail') & hasPerm('sysNotice:delete')"/>
