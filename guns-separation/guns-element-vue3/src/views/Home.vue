<template>
  <div class="home">
    ...
    <el-divider> AvatarList </el-divider>
    <el-card style="margin-bottom: 3rem">
      ...
      <el-divider type="vertical" style="margin: 0 16px" />
    ...
    <el-divider> CountDown </el-divider>
    <el-card style="margin-bottom: 3rem">
      <count-down
    ...
    <el-divider> Ellipsis </el-divider>
    <el-card style="margin-bottom: 3rem">
    ...
    <el-divider> NumberInfo </el-divider>
    <el-card style="margin-bottom: 3rem">
      <number-info
    ...
    <el-divider> TagSelect </el-divider>
    <el-card style="margin-bottom: 3rem">
      <tag-select>
    ...
    <el-divider> DescriptionList </el-divider>
    <el-card style="margin-bottom: 3rem">
    ...
    <el-divider> TagCloud </el-divider>
    <el-card style="margin-bottom: 3rem">
