...
export default {
  ...
  methods: {
    ...
    renderSubMenu(menu) {
      ...
      // todo imortant! jsx见 https://github.com/vuejs/jsx-next/blob/dev/packages/babel-plugin-jsx/README-zh_CN.md
      const slots = {
        title: () => {
          {
            this.renderIcon(menu.meta.icon)
  ...
  render() {
    const dynamicProps = {
      ...
      // defaultActive: this.selectedKeys,
      menuTrigger: 'click',
    ...
    return <ElMenu {...dynamicProps}>{menuTree}</ElMenu>
  },
}
