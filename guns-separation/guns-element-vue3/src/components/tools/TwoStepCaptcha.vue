  ...
  >
    ...
    <template slot="footer">
      <div :style="{ textAlign: 'center' }">
        <el-button key="back" @click="handleCancel">返回</el-button>
        <el-button key="submit" type="primary" :loading="stepLoading" @click="handleStepOk">
          继续
        </el-button>
      </div>
    </template>
    ...
    <a-spin :spinning="stepLoading">
      <el-form layout="vertical" :auto-form-create="(form)=>{this.form = form}">
        <div class="step-form-wrapper">
          ...
          >
            <el-input :style="{ textAlign: 'center' }" @keyup.enter.native="handleStepOk" placeholder="000000" />
          </el-form-item>
