...
export default {
  ...
  methods: {
    ...
    renderAlert () {
      ...
      return ''
      /* return (
        <el-alert showIcon={true} style="margin-bottom: 16px">
  ...
  render () {
    ...
    const table = (
      <el-table {...{ props, scopedSlots: { ...this.$scopedSlots } }} onChange={this.loadData} onExpand={ (expanded, record) => { this.$emit('expand', expanded, record) } }>
