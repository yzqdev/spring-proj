...
interface JobService {
     ...
     * @return /
     */
    fun create(resources: Job)

    /**
     * 编辑
     * @param resources /
     */
    fun update(resources: Job)
     ...
     * @return /
     */
    fun queryAll(criteria: JobQueryCriteria?, pageable: Pageable?): Map<String?, Any?>
     ...
     * @return /
     */
    fun queryAll(criteria: JobQueryCriteria?): List<JobDto?>?
    ...
    fun download(queryAll: List<JobDto>, response: HttpServletResponse?)
