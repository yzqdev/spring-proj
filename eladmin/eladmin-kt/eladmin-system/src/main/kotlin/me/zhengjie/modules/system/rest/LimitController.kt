 ...
 */
package me.zhengjie.modules.system.restimportimportimport

me.zhengjie.annotation .rest.AnonymousGetMappingimport me.zhengjie.modules.system.rest.LimitControllerimport org.springframework.web.bind.annotation .RequestMappingimport org.springframework.web.bind.annotation .RestController io.swagger.v3.oas.annotations.Operation
import io.swagger.v3.oas.annotations.tags.Tagimport

me.zhengjie.annotation .Limitimport java.util.concurrent.atomic.AtomicInteger me.zhengjie.utils.PageUtil.toPage
...
class LimitController {
    ...
    fun test(): Int {
        return LimitController.Companion.ATOMIC_INTEGER.incrementAndGet()
    }

    companion object {
        private val ATOMIC_INTEGER = AtomicInteger()
    }
}