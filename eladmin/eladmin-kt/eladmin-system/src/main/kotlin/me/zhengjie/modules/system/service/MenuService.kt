...
interface MenuService {
    ...
    fun queryAll(criteria: MenuQueryCriteria, isQuery: Boolean): List<MenuDto?>?
     ...
     * @param resources /
     */
    fun create(resources: Menu)

    /**
     * 编辑
     * @param resources /
     */
    fun update(resources: Menu)
     ...
     * @return /
     */
    fun getChildMenus(menuList: List<Menu>, menuSet: MutableSet<Menu?>): Set<Menu?>
     ...
     * @return /
     */
    fun buildTree(menuDtos: List<MenuDto>): List<MenuDto>
     ...
     * @return /
     */
    fun buildMenus(menuDtos: List<MenuDto?>): Any
     ...
     * @return /
     */
    fun findOne(id: Long): Menu

    /**
     * 删除
     * @param menuSet /
     */
    fun delete(menuSet: Set<Menu>)
    ...
    fun download(queryAll: List<MenuDto>, response: HttpServletResponse?)
     ...
     * @return /
     */
    fun getMenus(pid: Long?): List<MenuDto?>?
     ...
     * @return /
     */
    fun getSuperior(menuDto: MenuDto, objects: MutableList<Menu?>): List<MenuDto>?
     ...
     * @return /
     */
    fun findByUser(currentUserId: Long?): List<MenuDto>
}