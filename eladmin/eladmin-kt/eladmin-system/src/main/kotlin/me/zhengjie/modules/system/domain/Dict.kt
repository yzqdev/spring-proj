 ...
 */
package me.zhengjie.modules.system.domainimportimportimport

me.zhengjie.base.BaseEntityimport me.zhengjie.modules.system.domain.DictDetailimport java.io.Serializableimport javax.persistence.* io.swagger.v3.oas.annotations.media.Schemaimport lombok.*import java.io.Serializable
import javax.persistence.*
import javax.validation.constraints.NotBlankimport

javax.validation.constraints.NotNull me.zhengjie.utils.PageUtil.toPage
...
@Setter
@Table(name = "sys_dict")
class Dict : BaseEntity(), Serializable {
    @Id
    @Column(name = "dict_id")
    ...
    private val dictDetails: List<DictDetail>? = null
