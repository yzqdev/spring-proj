 ...
 */
package me.zhengjie.modules.system.serviceimport
...
interface DeptService {
    ...
    fun queryAll(criteria: DeptQueryCriteria, isQuery: Boolean): List<DeptDto>?
     ...
     * @return /
     */
    fun findById(id: Long): DeptDto

    /**
     * 创建
     * @param resources /
     */
    fun create(resources: Dept)

    /**
     * 编辑
     * @param resources /
     */
    fun update(resources: Dept)

    /**
     * 删除
     * @param deptDtos /
     */
    fun delete(deptDtos: Set<DeptDto>)
     ...
     * @return /
     */
    fun findByPid(pid: Long): List<Dept?>?
     ...
     * @return /
     */
    fun findByRoleId(id: Long?): Set<Dept?>?
    ...
    fun download(queryAll: List<DeptDto>, response: HttpServletResponse?)
     ...
     * @return /
     */
    fun getDeleteDepts(deptList: List<Dept>, deptDtos: MutableSet<DeptDto?>): Set<DeptDto?>
     ...
     * @return /
     */
    fun getSuperior(deptDto: DeptDto, depts: MutableList<Dept?>): List<DeptDto>?
     ...
     * @return /
     */
    fun buildTree(deptDtos: List<DeptDto>): Any
     ...
     * @return
     */
    fun getDeptChildren(deptList: List<Dept?>): List<Long>

    /**
     * 验证是否被角色或用户关联
     * @param deptDtos /
     */
    fun verification(deptDtos: Set<DeptDto>)
}