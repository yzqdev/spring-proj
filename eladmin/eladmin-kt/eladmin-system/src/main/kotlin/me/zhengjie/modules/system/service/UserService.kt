...
interface UserService {
     ...
     */
    fun updatePass(username: String?, encryptPassword: String?)
     ...
     * @return /
     */
    fun updateAvatar(file: MultipartFile): Map<String?, String?>
     ...
     * @return /
     */
    fun queryAll(criteria: UserQueryCriteria?, pageable: Pageable?): Any
     ...
     * @return /
     */
    fun queryAll(criteria: UserQueryCriteria?): List<UserDto?>?
    ...
    fun download(queryAll: List<UserDto>, response: HttpServletResponse?)

    /**
     * 用户自助修改资料
     * @param resources /
     */
    fun updateCenter(resources: User)
}