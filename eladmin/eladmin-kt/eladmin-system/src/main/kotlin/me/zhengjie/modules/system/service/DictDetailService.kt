 ...
 * @date 2019-04-10
 */
interface DictDetailService {
    /**
     * 创建
     * @param resources /
     */
    fun create(resources: DictDetail)

    /**
     * 编辑
     * @param resources /
     */
    fun update(resources: DictDetail)
     ...
     * @return /
     */
    fun queryAll(criteria: DictDetailQueryCriteria?, pageable: Pageable?): Map<String?, Any?>
     ...
     * @return /
     */
    fun getDictByName(name: String?): List<DictDetailDto?>?
}