...
interface RoleService {
     ...
     * @param resources /
     */
    fun create(resources: Role)

    /**
     * 编辑
     * @param resources /
     */
    fun update(resources: Role)
     ...
     * @return /
     */
    fun findByUsersId(id: Long?): List<RoleSmallDto?>?
     ...
     * @return /
     */
    fun findByRoles(roles: Set<Role>): Int
     ...
     * @param roleDTO /
     */
    fun updateMenu(resources: Role, roleDTO: RoleDto)
     ...
     * @return /
     */
    fun queryAll(criteria: RoleQueryCriteria?, pageable: Pageable?): Any
     ...
     * @return /
     */
    fun queryAll(criteria: RoleQueryCriteria?): List<RoleDto?>?
    ...
    fun download(queryAll: List<RoleDto>, response: HttpServletResponse?)
     ...
     * @return 权限信息
     */
    fun mapToGrantedAuthorities(user: UserDto): List<GrantedAuthority>

    /**
     * 验证是否被用户关联
     * @param ids /
     */
    fun verification(ids: Set<Long?>?)
