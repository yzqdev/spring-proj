...
interface DictService {
     ...
     * @return /
     */
    fun queryAll(criteria: DictQueryCriteria?, pageable: Pageable?): Map<String?, Any?>
     ...
     * @return /
     */
    fun queryAll(dict: DictQueryCriteria?): List<DictDto?>?
     ...
     * @return /
     */
    fun create(resources: Dict)

    /**
     * 编辑
     * @param resources /
     */
    fun update(resources: Dict)
    ...
    fun download(queryAll: List<DictDto>, response: HttpServletResponse?)
}