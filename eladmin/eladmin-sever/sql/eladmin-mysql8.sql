...
-- ----------------------------
INSERT INTO `code_column_config` VALUES (191, 'tool_qiniu_content', 'content_id', 'bigint', NULL, 'auto_increment', b'1', NULL, 'PRI', b'1', b'0', NULL, 'ID', NULL);
INSERT INTO `code_column_config` VALUES (192, 'tool_qiniu_content', 'bucket', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, 'Bucket 识别符', NULL);
INSERT INTO `code_column_config` VALUES (193, 'tool_qiniu_content', 'name', 'varchar', NULL, '', b'1', NULL, 'UNI', b'1', b'0', NULL, '文件名称', NULL);
INSERT INTO `code_column_config` VALUES (194, 'tool_qiniu_content', 'size', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '文件大小', NULL);
INSERT INTO `code_column_config` VALUES (195, 'tool_qiniu_content', 'type', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '文件类型：私有或公开', NULL);
INSERT INTO `code_column_config` VALUES (196, 'tool_qiniu_content', 'url', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '文件url', NULL);
INSERT INTO `code_column_config` VALUES (197, 'tool_qiniu_content', 'suffix', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '文件后缀', NULL);
INSERT INTO `code_column_config` VALUES (198, 'tool_qiniu_content', 'update_time', 'datetime', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '上传或同步的时间', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成器配置' ROW_FORMAT = COMPACT;
...
-- ----------------------------
INSERT INTO `mnt_database` VALUES ('76ede40de26e4f28ac295e6681e769fe', 'ceshi', 'jdbc:mysql://localhost:3306/first', 'root', '123456', 'admin', 'admin', '2021-08-31 14:30:34', '2021-08-31 14:30:34');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3557 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (3556, '删除所有INFO日志', 'INFO', 'me.zhengjie.rest.LogController.delAllInfoLog()', '', '192.168.137.1', 134, 'admin', '内网IP', 'Edge 92.0.902.84', NULL, '2021-09-04 14:23:39');
INSERT INTO `sys_log` VALUES (3557, '导出数据', 'INFO', 'me.zhengjie.rest.LogController.download()', '', '192.168.137.1', 1275, 'admin', '内网IP', 'Edge 94.0.992.38', NULL, '2021-10-10 22:59:53');
...
INSERT INTO `sys_menu` VALUES (2, 1, 3, 1, '用户管理', 'User', 'system/user', 2, 'peoples', 'user', b'0', b'0', b'0', 'user:list', NULL, NULL, '2018-12-18 15:14:44', NULL);
INSERT INTO `sys_menu` VALUES (3, 1, 3, 1, '角色管理', 'Role', 'system/Role', 3, 'role', 'role', b'0', b'0', b'0', 'roles:list', NULL, 'admin', '2018-12-18 15:16:07', '2021-08-31 17:22:07');
INSERT INTO `sys_menu` VALUES (5, 1, 3, 1, '菜单管理', 'Menu', 'system/Menu', 5, 'menu', 'menu', b'0', b'0', b'0', 'menu:list', NULL, NULL, '2018-12-18 15:17:28', NULL);
...
INSERT INTO `sys_menu` VALUES (7, 6, 0, 1, '操作日志', 'Log', 'monitor/log/Log', 11, 'log', 'logs', b'0', b'1', b'0', NULL, NULL, 'admin', '2018-12-18 15:18:26', '2021-08-31 17:35:21');
INSERT INTO `sys_menu` VALUES (9, 6, 0, 1, 'SQL监控', 'Sql', 'monitor/Sql', 18, 'sqlMonitor', 'druid', b'0', b'0', b'0', NULL, NULL, 'admin', '2018-12-18 15:19:34', '2021-08-31 17:34:26');
...
INSERT INTO `sys_menu` VALUES (28, 1, 3, 1, '任务调度', 'Timing', 'system/timing/Timing', 999, 'timing', 'timing', b'0', b'0', b'0', 'timing:list', NULL, 'admin', '2019-01-07 20:34:40', '2021-08-31 17:33:28');
...
INSERT INTO `sys_menu` VALUES (37, 1, 3, 1, '岗位管理', 'Job', 'system/job/Job', 7, 'Steve-Jobs', 'job', b'0', b'0', b'0', 'job:list', NULL, 'admin', '2019-03-29 13:51:18', '2021-08-31 17:29:56');
...
INSERT INTO `sys_menu` VALUES (39, 1, 3, 1, '字典管理', 'Dict', 'system/dict/Dict', 8, 'dictionary', 'dict', b'0', b'0', b'0', 'dict:list', NULL, 'admin', '2019-04-10 11:49:04', '2021-08-31 17:31:47');
INSERT INTO `sys_menu` VALUES (41, 6, 0, 1, '在线用户', 'OnlineUser', 'monitor/Online', 10, 'Steve-Jobs', 'online', b'0', b'0', b'0', NULL, NULL, 'admin', '2019-10-26 22:08:43', '2021-08-31 17:33:47');
...
INSERT INTO `sys_menu` VALUES (80, 6, 0, 1, '服务监控', 'ServerMonitor', 'monitor/Server', 14, 'codeConsole', 'server', b'0', b'0', b'0', 'monitor:list', NULL, 'admin', '2019-11-07 13:06:39', '2021-08-31 17:34:04');
...
INSERT INTO `sys_menu` VALUES (92, 90, 3, 1, '服务器', 'ServerDeploy', 'mnt/MntServer', 22, 'server', 'mnt/serverDeploy', b'0', b'0', b'0', 'serverDeploy:list', NULL, 'admin', '2019-11-10 10:29:25', '2021-08-31 17:36:37');
INSERT INTO `sys_menu` VALUES (93, 90, 3, 1, '应用管理', 'App', 'mnt/AppList', 23, 'app', 'mnt/app', b'0', b'0', b'0', 'app:list', NULL, 'admin', '2019-11-10 11:05:16', '2021-08-31 17:37:27');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '管理员', '男', '18856958745', '201507802@qq.com', '', 'https://img-static.mihoyo.com/communityweb/upload/97734c89374997c7c87d5af5f7442171.png', '$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa', b'1', 1, NULL, 'admin', '2020-05-03 16:38:31', '2018-08-23 09:11:56', '2021-08-31 14:29:29');
